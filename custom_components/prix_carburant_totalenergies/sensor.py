...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    async_add_entities(
        [Fuel(coordinator, station_id, fuel, label) for station_id in coordinator.data for fuel, label in FUEL_LABELS.items()]
    )
...
class Fuel(SensorEntity):
    ...
    def extra_state_attributes(self):
        ...
        return {
            ...
            "price_status": "rupture" if value.get("price") == "rupture" else "available",
